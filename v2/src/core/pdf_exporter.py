    ...
    def generate_shares_table_html(
        ...
        html_parts.extend(
            [
                ...
                "<thead>",
                "<tr>",
                "<th style='width: 8.33%'>Symbol</th>",
                "<th style='width: 8.33%'>Anzahl</th>",
                "<th style='width: 8.33%'>Datum<br>Kauf</th>",
                "<th style='width: 8.33%'>Datum<br>Verkauf</th>",
                "<th style='width: 8.33%'>Kurs<br>Kauf</th>",
                "<th style='width: 8.33%'>Kurs<br>Verkauf</th>",
                "<th style='width: 8.33%'>Kurs<br>Kauf [€]</th>",
                "<th style='width: 8.33%'>Kurs<br>Verkauf [€]</th>",
                "<th style='width: 8.33%'>Wert<br>Kauf [€]</th>",
                "<th style='width: 8.33%'>Wert<br>Verkauf [€]</th>",
                "<th style='width: 8.33%'>Transaktions-<br>kosten [€]</th>",
                "<th style='width: 8.33%'>Gewinn/Verlust<br>[€]</th>",
                "</tr>",
                "</thead>",
                "<tbody>",
            ]
