...
parser = argparse.ArgumentParser(
    description="Convert Interactive Brokers CSV output to XLSX for later processing"
)
parser.add_argument(
    "-i", "--csv",
    dest="csv_filename",
    type=str,
    required=True,
    help="CSV file from Interactive Brokers Activity report output",
)
parser.add_argument(
    "-o", "--xlsx",
    dest="xlsx_filename",
...
parser.add_argument(
    ...
    help="Replace tickers in the 'symbol' column to ISIN",
)
